# TODO
All new issues, possible features and bugfixes for Andes will be documented in this file.

## Backlog
- [ ] Add support for models with images ([#3](https://github.com/aqerd/andes/issues/3));
- [ ] History saving locally ([#5](https://github.com/aqerd/andes/issues/5));
- [ ] Add support for custom models ([#6](https://github.com/aqerd/andes/issues/6));
